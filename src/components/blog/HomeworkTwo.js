...
class HomeworkTwo extends Component {
	constructor(props) {
		super(props);
	}

	handleChange(text) {
		this.props.dispatch(setPostText("homework2", text));
	}

	toggleEditing() {
		this.props.dispatch(togglePostEditing("homework2"));
	}

	render() {
		const post = this.props.blog.posts.homework2;
